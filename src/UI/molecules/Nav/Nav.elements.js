...
export const ContentContainer = styled('section')(({ theme }) => ({ display: 'flex', flexDirection:'column', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-evenly', columnGap: theme.spacing(2), maxWidth: '1290px', width: '100%',})) // This is to make the spacing proper even for large desktops