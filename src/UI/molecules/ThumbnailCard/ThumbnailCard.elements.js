...
export const StyledCardHeadline = styled('div')(({ theme }) => ({
    ...
    '& p': {
        ...
        [theme.breakpoints.up(700)]: { WebkitLineClamp: 4, },
        [theme.breakpoints.up(900)]: { WebkitLineClamp: 2, },
        ...
        [theme.breakpoints.up(1700)]: { fontSize: theme.typography.body1.fontSize },
