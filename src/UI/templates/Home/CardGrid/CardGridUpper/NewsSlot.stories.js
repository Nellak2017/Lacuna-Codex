...
const cards = [ // thumbnail, thumbnailAlt, avatar, avatarAlt, category, title, subtitle, info
    { category: 'First Category', title: 'First Card', subtitle: lorem, info: 'Apr 3, 2025' },
    { category: 'Second Category', title: 'Second Card', subtitle: lorem, info: 'Apr 4, 2025' },
    { category: 'Third Category', title: 'Third Card', subtitle: lorem, info: 'Apr 5, 2025' },
    { category: 'Fourth Category', title: 'Fourth Card', subtitle: lorem, info: 'Apr 6, 2025' },
    { category: 'Fifth Category', title: 'Fifth Card', subtitle: lorem, info: 'Apr 7, 2025' },
]
