...
const AuthInput = React.forwardRef((props, ref) => (<input ref={ref} {...props} />)); AuthInput.displayName = 'AuthInput' /*TODO: Properly implement*/ //React.forwardRef((props, ref) => (<TaskInput ref={ref} {...props} />)); AuthInput.displayName = 'AuthInput'
